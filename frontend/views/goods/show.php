...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li id="member_status">您好，欢迎来到京西！
                    [<a href="http://www.yii2shop.com/site/login">登录</a>]
                    [<a href="http://www.yii2shop.com/site/signup">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <?php foreach($model2 as $good):?>
                <h3><strong><?=$good->content?></strong></h3>
            <?php endforeach; ?>
            <!-- 图片预览区域 start -->
            <div class="preview fl">
                ...
                中大图分配到 a 标签的href属性，中图分配到 img 的src上。 下面的smallpic 则表示小图区域，格式固定，在 a 标签的 rel属性中，
                分别指定了中图（smallimage）和大图（largeimage），img标签则显示小图，按此格式循环生成即可，但在第一个li上，要加上cur类，同时在第一个li 的a标签中，添加类 zoomThumbActive  -->
                            ...
                            <?php foreach($model as $goods):?>
                                <li class="cur">
                                    <a class="zoomThumbActive" href="javascript:void(0);"
                                       rel="{gallery: 'gal1', smallimage: '<?=$goods->logo?>',largeimage: '<?=$goods->logo?>">
                                        <img src="<?=$goods->logo?>" alt=""/></a>
                                </li>
                            <?php endforeach; ?>
                            <?php foreach($model3 as $gg):?>
                                <li>
                                    <a href="javascript:void(0);"
                                       rel="{gallery: 'gal1', smallimage: '<?=$gg->path?>',largeimage: '/images/preview_l2.jpg'}">
                                        <img src="<?=$gg->path?>"></a>
                                </li>
                                <!--                            <li>-->
                                <!--                                <a href="javascript:void(0);"-->
...
<script>
    //发送ajax请求获取用户登录状态,根据登录状态改变状态信息
    $.getJSON("<?=\yii\helpers\Url::to(['goods/member-status'])?>",function (json) {
        if (json.is_login){
            $("#member_status").html('您好,欢迎来到本商城'+json.username+'[<a href="http://www.yii2shop.com/site/logout">注销</a>]');
        }
    })
</script>
</body>
